...
const Success = () => {
  ...
  const isUnderAnalysis = order.status === 'EM_ANALISE';
        ...
        <div className="text-center mb-8">
          <h1
            ...
            className={cn(
              ...
              isApproved ? 'text-success' : isUnderAnalysis ? 'text-warning' : 'text-destructive'
            )}
          >
            {isApproved ? 'Pedido Aprovado!' : isUnderAnalysis ? 'Pedido em Análise!' : 'Crédito Reprovado'}
          </h1>
          <p className="text-muted-foreground">
            {isApproved
              ? 'Seu pedido foi processado com sucesso. Em breve entraremos em contato.'
              : isUnderAnalysis
              ? 'Seu pedido foi recebido e a análise de crédito está em andamento. Você pode acompanhar o status pela busca.'
